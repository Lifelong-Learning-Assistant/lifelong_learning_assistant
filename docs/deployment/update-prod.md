...
Этот скрипт:
1. Создаст необходимые Docker сети.
2. Скачает бэкапы знаний (Qdrant/Redis) и импортирует их.
3. Создаст структуру таблиц в PostgreSQL и зарегистрирует тестового пользователя.
